...
def calcular_bollinger():
    ...
    media_movil, upper_band, lower_band = calcular_bollinger_func(closes, periodo, desviacion)

    return media_movil, upper_band, lower_band, closes  # Retornar los valores calculados y los precios de cierre
